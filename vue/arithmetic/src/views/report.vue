  ...
  <div class="report">
    <div class="g-title">
      ...
      <div class="m-face-img">
        <div class="s-face-content">
          <img src="https://faceplus.qqwechat.com/2019-02-27_cbff441075c43a15348d0362252da1fd.png?x-oss-process=image/crop,x_87,y_156,w_534,h_534">
        </div>
        <div class="face-result-line1" style="top: 1.08rem; left: 4.9706rem;"></div>
        <div class="face-result-line2" style="top: 2.45263rem; left: 3.96397rem;"></div>
        <div class="face-result-splot" style="top: 0.933333rem; left: 4.82393rem;">
          <div class="face-result-item"></div>
        </div>
        <div class="face-result-splot" style="top: 2.30596rem; left: 3.81731rem;">
          <div class="face-result-item"></div>
        </div>
        <div class="face-result-text" style="top: 0.45rem; left: 8rem;">上庭较长</div>
        <div class="face-result-text" style="top: 1.77263rem; left: 0.666667rem;">眼睛细长</div>
      </div>
    </div>
    ...
    <div class="result-features--box">
      <div class="result-features">
        <div class="result-features__five">
          ...
          <div class="result-features-type">
            <div class="result-features-type-title">
              <div class="result-features-type-title-type">/水木型面相</div>
            </div>
            <div class="index-order">
              <div class="users-info">
                <img src="../assets/images/shui.png" class="users-info_backgr">
                <div class="users-info__name">水</div>
                <div class="users-info__bot"></div>
                <p data-v-255811e4="">86%</p>
              </div>
              <div class="users-info">
                <img src="../assets/images/mu.png" class="users-info_backgr">
                <div class="users-info__name">木</div>
                <div class="users-info__bot"></div>
                <p data-v-255811e4="">14%</p>
              </div>
            </div>
          </div>
        </div>
        <div class="result-features__text-card">
          ...
          <div class="result-features__text-card--title">水型脸，五官带木。相生相化之格。身材修长，面肥而不浑厚，眉淡腰软，臀部平直。</div>
        </div>
        <div class="result-features__text-card">
          <div class="result-features__text-card--title">
            水兼木型格局的人缺乏精气神，眼圆无神，但个性急躁，做事容易出小差错，年少时期欠缺经验没有大成就，成功机会很多但是抓不住，努力也只能略享富贵。要控制好不要过于长胖，如果肥肉过多，浮而下垂，内分泌系统容易产生健康问题。面色青滞，带木重，格局相生不化，木重水枯，易多发灾祸。
          </div>
        </div>
      </div>
    </div>
  ...
  .g-title
    ...
    .m-face-img
      ...
      .s-face-content
        ...
        margin: 0.86666667rem auto;
        border: 0.13333333rem solid #666;
        overflow: hidden;
        background: #fff;
        border-radius: 100%;
        animation: fadein 2s;
